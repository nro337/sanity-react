      ...
      <div class="shadow bg-base-200 drawer h-full">
        ...
        <div class="flex flex-col drawer-content">
          <div class="w-full navbar bg-base-300">
            ...
            <div class="pr-4 mx-auto lg:ml-40">
              <a href="/">
          ...
          <div className="container mx-auto pb-8">
            <h2 className="text-6xl flex justify-center cursive text-blue-400 my-4">
              The Lead
            </h2>
            <div className="grid px-4 md:grid-cols-3 lg:grid-cols-5 grid-rows-1 gap-8">
              ...
              <div className="col-span-1 grid-row-1 w-auto min-h-screen">
                <h1 className="text-center mb-2">Recent Meets</h1>
                <iframe
                  title="TFRRS"
          ...
          <footer class="items-center p-4 mt-8 footer bg-neutral text-neutral-content rounded-box bg-base-300">
